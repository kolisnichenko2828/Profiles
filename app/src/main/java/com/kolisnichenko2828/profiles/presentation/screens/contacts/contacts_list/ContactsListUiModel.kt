...
fun ContactsListUiModel.toDomain(): ContactModel {
    return ContactModel(
        id = this.id,
...
fun List<ContactsListUiModel>.toDomain(): List<ContactModel> {
    return this.map { it.toDomain() }
}

fun ContactModel.toUi(): ContactsListUiModel {
...
fun List<ContactModel>.toUi(): List<ContactsListUiModel> {
